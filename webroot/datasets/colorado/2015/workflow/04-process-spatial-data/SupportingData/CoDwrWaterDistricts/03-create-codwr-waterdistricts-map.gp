...
# - output to the dist/infomapper folder for use by the InfoMapper
...
CreateGeoMapProject(NewGeoMapProjectID="WaterDistrictsProject",ProjectType="SingleMap",Name="CO DWR Water Districts",Description="Colorado Division 5 water districts for water administration.",Properties="author:'Open Water Foundation',specificationVersion:'1.0.0'")
CreateGeoMap(NewGeoMapID="WaterDistrictsMap",Name="CO DWR Water Districts",Description="Colorado Division of Water Resources water districts for water administration.",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-107.9819,39.6923,9'")
...
#
AddGeoLayerViewGroupToGeoMap(GeoLayerViewGroupID="WaterDistrictsGroup",Name="CO DWR Water Districts",Description="Water District boundaries for Division 5 from the Colorado Division of Water Resources.",Properties="selectedInitial: true",InsertPosition="Top")
#
